	...
	const [projects] = useState<IProject[]>([
		{
			...
			description:
				'App criado com React Native servindo de guia para o fantástico jogo Phasmophobia!',
		...
		},
		{
			...
			description:
				'Um app simples utilizando a api do youtube com reactjs e nodejs.',
		...
		},
		{
			...
			description:
				'Joguinho simples de sudoku utilizando a api "Solve Sudoku" do rapidapi para resolver o puzzle.',
		...
		},
		{
			...
			description:
				'Desenvolvi esse portfólio para mostrar meus projetos e habilidades utilizando como base o template do Codewell.',
		...
		},
		{
			...
			tech: 'HTML, CSS, JS, ReactJS',
			description:
				'Uma landing page com um design simples, responsivo e clean.',
		...
		},
		{
			...
			description:
				'Veja informações detalhadas sobre os países do mundo inteiro.',
		...
		},
		{
			...
			description:
				'Projeto onde você pode criar e votar em enquetes, além de poder ver as estatísticas delas.',
		...
		},
		{
			...
			description:
				'Um clone da interface da Netflix utilizando a api do themoviedb.',
		...
		},
		{
			...
			description:
				'Clone do fórum Reddit e algumas de suas funcionalidades como criar comunidades, postar informações e comentá-las!',
			image: 'https://i.imgur.com/4cSSc0K.png',
			links: [
				{
					id: 1,
					url: 'https://github.com/Flaviogameover/Reddit',
					icon: <BsGithub />,
				},
				{
					id: 2,
